...
def form_url(params):
	base_url = str(stp_config.CONST.API_URL_PREFIX) + 'bsmart_data/bsmart_data/stp_ws/stp_contract_item_detail/'
...
def render(res, params):
	...
	worksheet.insert_image('B1', r'\\ykr-apexp1\staticenv\apps\199\env_internal_bw.png',{'x_offset':110,'y_offset':30, 'x_scale':0.5,'y_scale':0.5, 'positioning':2})
