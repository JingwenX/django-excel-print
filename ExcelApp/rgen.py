...
r_dict = {
    	...
    	"17" : [stp_wrsa.Report, 'Warranty Report Species Analysis - 1 year warranty'],
    	"18" : [stp_wrsa.Report, 'Warranty Report Species Analysis - 2 year warranty'],
    	"19" : [stp_wrsa.Report, 'Warranty Report Species Analysis - 12 months warranty'],
